...
// assertGrammarVersion === 2  (current)
```
...
|------|-----------------------|
| `legacy-contains-v1.md` | `contains`, `not-contains`, `exists` |
| `legacy-assertions-v1.md` | `not-exists`, `matches`, `toml-keys` |
| `legacy-matches-v2.md` | `matches` (v2 patterns), `contains`, `exists` |
